...
class LyrToSld(SlyrAlgorithm):
    ...
    def displayName(self):
        return "Convert LYR to SLD"

    def shortDescription(self):
        return "Converts an ESRI LYR file to a OGC SLD file (or files)"
    ...
    def shortHelpString(self):
        return (
            "Converts an ESRI LYR file to a OGC SLD file. If multiple "
