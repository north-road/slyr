...
class ConfigOptionsPage(OPTIONS_WIDGET, QgsOptionsPageWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.convert_font_to_simple_marker.setChecked(int(s.value('/plugins/slyr/convert_fonts_to_simple_markers', 1)))
    ...
    def apply(self):
        ...
        s.setValue('/plugins/slyr/convert_fonts_to_simple_markers', 0 if not self.convert_font_to_simple_marker.isChecked() else 1)
