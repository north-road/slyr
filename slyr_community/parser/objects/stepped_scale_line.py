...
class SteppedScaleLine(ScalebarBase):
    """
    SteppedScaleLine
    """
    ...
    @staticmethod
    def cls_id():
        return "6589f141-f7f7-11d2-b872-00600802e603"

    def __init__(self):  # pylint: disable=useless-super-delegation
        super().__init__()

    def read(self, stream: Stream, version):
        super()._read(stream, version, "Stepped Scale Line")
        ...
        stream.read_double("unknown", expected=10)
