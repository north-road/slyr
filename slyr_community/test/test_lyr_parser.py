...
expected = [
    ...
    {"filename": "wms_not_transparent_background.lyr"},
    {"filename": "wms_transparent_background.lyr"},
    {"filename": "wms_63_transparency.lyr"},
    {"filename": "wms_green_background.lyr"},
    {"filename": "wms_format_jpeg.lyr"},
    {"filename": "wms_format_png24.lyr"},
    {"filename": "wms_attributes.lyr"},
    {"filename": "wms_all_checked.lyr"},
    {"filename": "wms_none_checked.lyr"},
    {"filename": "wms_zoom_range.lyr"},
    {"filename": "wms_format_png8.lyr"},
    {"filename": "wms_custom_params.lyr"},
    {"filename": "wms_png_32.lyr"},
    {"filename": "wms_footprint_image_subset_only.lyr"},
    {"filename": "wms_use_footprint_style.lyr"},
    {"filename": "wms_1.lyr"},
    ...
    {"filename": "mapserver_37_transparent.lyr", "skip": True},
    {"filename": "mapserver_world_imagery.lyr", "skip": True},
    {"filename": "mapserver_clear_cache_when_session_ends.lyr", "skip": True},
    {"filename": "mapserver_scalerange.lyr", "skip": True},
    {"filename": "mapserver_invisible.lyr", "skip": True},
    {"filename": "mapserver_keep_cache_between_sessions.lyr", "skip": True},
    {"filename": "mapserver_attributes.lyr", "skip": True},
    {"filename": "mapserver_dont_cache.lyr", "skip": True},
    {"filename": "mapserver_scalerange_deactivated.lyr", "skip": True},
    ...
    {"filename": "openstreetmap.lyr"},
    {"filename": "bing_maps_dont_cache.lyr"},
    {"filename": "bing_maps_clear_cache_session_ends.lyr"},
    {
        "filename": "bing_maps_zoom_range.lyr",
        "skip": True,  # doesn't seem to have saved zoom range
    },
    {"filename": "bing_maps_unchecked.lyr"},
    {"filename": "imageserver_mosaic_method_north_west.lyr"},
    {"filename": "imageserver_mosaic_closest_to_center.lyr"},
    {"filename": "imageserver_allow_interactive_effects.lyr"},
    {"filename": "imageserver_mosaic_method_none.lyr"},
    {"filename": "imageserver_mosaic_operator_min.lyr"},
    {"filename": "image_server_scale_range_deactivated.lyr"},
    {"filename": "imageserver_def_query.lyr"},
    {"filename": "imageserver_resample_bilinear.lyr"},
    {"filename": "imageserver_cache.lyr", "skip": True},
    {"filename": "imageserver_mosaic_method_seamline_operator_first.lyr"},
    {"filename": "imageserver_mosaic_closest_nadir.lyr"},
    {"filename": "imageserver_mosaic_attr_centery.lyr"},
    {"filename": "imageserver_compression_quality_85.lyr"},
    {"filename": "imageserver_compression_lz77.lyr"},
    {"filename": "image_server_display_resolution_in_toc.lyr"},
    {"filename": "image_server_scale_range.lyr"},
    {"filename": "image_server_unchecked.lyr"},
    {"filename": "imageserver_no_display_footprints_primary_rasters_only.lyr"},
    {"filename": "imageserver_mosaic_operator_sum.lyr"},
    {"filename": "imageserver_return_raw_pixel_values.lyr"},
    {"filename": "imageserver_lerc_compression.lyr"},
    {"filename": "imageserver_mosaic_order_descending.lyr"},
    {"filename": "imageserver_processing_template_ahn_contour.lyr"},
    {"filename": "imageserver_mosaic_operator_mean.lyr"},
    {"filename": "imageserver_mosaic_operator_last.lyr"},
    {"filename": "imageserver_no_compression.lyr"},
    {"filename": "imageserver_jpeg.lyr"},
    {"filename": "imageserver_mosaic_order_base_value_19.lyr"},
    {"filename": "imageserver_use_selection_symbol_green.lyr"},
    {"filename": "imageserver_mosaic_operator_max.lyr"},
    {"filename": "imageserver_use_selection_color_purple.lyr"},
    {"filename": "imageserver_mosaic_by_attr_centerx.lyr"},
    {"filename": "imageserver_brightness77_contrast78_transparency79.lyr"},
    {"filename": "imageserver_resample_majority.lyr"},
    {"filename": "imageserver_enable_time.lyr"},
    {"filename": "imageserver_mosaic_closest_to_viewpoint.lyr"},
    {"filename": "imageserver_renderer_stats_from_image_service.lyr"},
    {"filename": "imageserver_resample_nearest_neighbour.lyr"},
    {"filename": "imageserver_mosaic_operator_blend.lyr"},
    {"filename": "imageserver.lyr"},
    {
        "filename": "imageserver_fields.lyr"  # settings are not saved
    },
    {"filename": "imageserver_mosaic_lock_raster_id99.lyr"},
    {"filename": "imageserver_show_footprints_blue_symbol.lyr"},
    {"filename": "imageserver_resample_cubic.lyr"},
    {
