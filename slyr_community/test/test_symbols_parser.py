...
expected = {
    ...
    "linev2_bin": {"lines.bin": True, "lines2.bin": True},
    "marker_bin": {
...
class TestSymbolParser(unittest.TestCase):
    ...
    def run_symbol_checks(self, path):  # pylint: disable=too-many-locals
        ...
        for file in blobs:
            ...
            expected_file = os.path.join(folder, "expected", base + ".txt")
            expected_converted_file = os.path.join(folder, "converted", base + ".txt")
            ...
            with open(file, "rb") as f:
                ...
                if isinstance(symbol, MultiLayerSymbol):
                    ...
                    try:
                        ...
                        if self.UPDATE:
                            with open(
                                expected_converted_file, "wt", encoding="utf8"
                            ) as o:
    ...
    def test_lines(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "line_bin")
    ...
    def test_fills(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "fill_bin")
        self.run_symbol_checks(path)
    ...
    def test_markers(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "marker_bin")
        self.run_symbol_checks(path)
    ...
    def test_hsv(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "hsv_bin")
        self.run_symbol_checks(path)
    ...
    def test_cmyk(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "cmyk_bin")
        self.run_symbol_checks(path)
    ...
    def test_ramps(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "ramps_bin")
        self.run_symbol_checks(path)
    ...
    def test_color_symbol(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "color_symbol")
        self.run_symbol_checks(path)
    ...
    def test_text_symbols(self):
        ...
        Test text symbols
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "text_bin")
        self.run_symbol_checks(path)
    ...
    def test_label_symbols(self):
        ...
        Test label symbols
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "labels_bin")
        self.run_symbol_checks(path)
    ...
    def test_maplex_points(self):
        ...
        Test label symbols
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "maplex_points_bin")
        self.run_symbol_checks(path)
    ...
    def test_maplex_lines(self):
        ...
        Test label symbols
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "maplex_lines_bin")
        self.run_symbol_checks(path)
    ...
    def test_maplex_polygon(self):
        ...
        Test label symbols
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "maplex_polygons_bin")
        self.run_symbol_checks(path)
    ...
    def test_symbols3d(self):
        ...
        Test 3d symbols
        """
        path = os.path.join(os.path.dirname(__file__), "styles", "symbols3d_bin")
        self.run_symbol_checks(path)
    ...
    def test_clsid_parsing(self):
        ...
        """
        self.assertEqual(
            ObjectRegistry.clsid_to_hex("7914e603-c892-11d0-8bb6-080009ee4e41"),
