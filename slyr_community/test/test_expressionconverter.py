...
class TestExpressionConverter(SlyrTestCase):
    ...
    def test_python(self):
        ...
        self.assertEqual(
            ExpressionConverter.convert_python_expression("[A_field123]", context),
            '"A_field123"',
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ExpressionConverter.convert_python_expression("len([a field])", context),
            'length("a field")',
        )
        self.assertEqual(
            ExpressionConverter.convert_python_expression('len("a value")', context),
            "length('a value')",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ExpressionConverter.convert_python_expression(
                "[a field] .title()", context
            ),
            'title("a field")',
        )
        self.assertEqual(
            ExpressionConverter.convert_python_expression('"abc"', context), "'abc'"
        )
        self.assertEqual(
            ExpressionConverter.convert_python_expression('"abc".title()', context),
            "title('abc')",
        )
        self.assertEqual(
            ExpressionConverter.convert_python_expression(
        ...
        self.assertEqual(
            ExpressionConverter.convert_python_expression('"Chat. d\'eau"', context),
            "'Chat. d''eau'",
        )
        self.assertEqual(
            ExpressionConverter.convert_python_expression(
    ...
    def test_esri(self):
        ...
        context = Context()
        self.assertEqual(ExpressionConverter.convert_esri_expression("[]", context), "")

        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[a field]", context),
            '"a field"',
        )
        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[§_Schutz]", context),
            '"§_Schutz"',
        )
        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[ESTA€ÇO]", context),
            '"ESTA€ÇO"',
        )
        self.assertEqual(
            ExpressionConverter.convert_esri_expression(
        ...
        self.assertEqual(
            ExpressionConverter.convert_esri_expression(
                "[Rivers, Streams.WC_LLID_NR]", context
            ),
            '"WC_LLID_NR"',
        )
        context.dataset_name = "Rivers[ Streams"
        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[WC_LLID_NR]", context),
            '"WC_LLID_NR"',
        )
        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[NAME\n]", context), '"NAME"'
        )
        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[NAME\r\n]", context), '"NAME"'
        )
        self.assertEqual(
            ExpressionConverter.convert_esri_expression("[NAME\r]", context), '"NAME"'
        )
    ...
    def test_vbscript(self):
        ...
        self.assertEqual(
            ExpressionConverter.convert_vbscript_expression("[a field]", context),
            '"a field"',
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ExpressionConverter.convert_vbscript_expression("[ESTA€ÇO]", context),
            '"ESTA€ÇO"',
        )
        self.assertEqual(
            ExpressionConverter.convert_vbscript_expression("[NAME\r]", context),
            '"NAME"',
        )
        self.assertEqual(
            ExpressionConverter.convert_vbscript_expression("[NAME\r\n]", context),
            '"NAME"',
        )
        self.assertEqual(
            ExpressionConverter.convert_vbscript_expression("[]", context), ""
