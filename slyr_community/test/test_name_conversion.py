...
expected = {
    ...
    "GDB Point": {
        "object": {
            ...
            "dataset_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_LOCALDATABASE_WORKSPACE",
                "workspace_factory": {"type": "FileGDBWorkspaceFactory", "version": 1},
                "name_string": "",
                "type": "WorkspaceName",
                "version": 1,
            },
    ...
    "Personal geodatabase table": {
        "object": {
            ...
            "workspace_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_LOCALDATABASE_WORKSPACE",
                "workspace_factory": {"type": "AccessWorkspaceFactory", "version": 1},
                "name_string": "",
                "type": "WorkspaceName",
                "version": 1,
            },
    ...
    "Ole DB factory": {
        "object": {
            ...
            "workspace_name": {
                ...
                "workspace_factory": {"type": "OLEDBWorkspaceFactory", "version": 1},
                "name_string": "",
                "type": "WorkspaceName",
                "version": 1,
            },
    ...
    "text file": {
        "object": {
            ...
            "workspace_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_FILESYSTEM_WORKSPACE",
                "workspace_factory": {"type": "TextFileWorkspaceFactory", "version": 1},
                "name_string": "",
                "type": "WorkspaceName",
                "version": 1,
            },
    ...
    "GPKG with table name": {
        "object": {
            ...
            "dataset_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_LOCALDATABASE_WORKSPACE",
                "workspace_factory": {"type": "GpkgWorkspaceFactory", "version": 1},
                "name_string": "",
                "type": "WorkspaceName",
                "version": 1,
            },
    ...
    "GPKG": {
        "object": {
            ...
            "topologies": [],
            "query": {
                "query": "select fid, geom from main.jjhjassddd",
                "fid": "fid",
                "geometry_field": "geom",
                "esri_oid": "ESRI_OID",
                "fields": {
        ...
        "object": {
            ...
            "dataset_name": {
                ...
                "workspace_name": {
                    ...
                    "path_name": "",
                    "workspace_type": "ESRI_FILESYSTEM_WORKSPACE",
                    "workspace_factory": {"type": "SdcWorkspaceFactory", "version": 1},
                    "name_string": "",
                    "type": "WorkspaceName",
                    "version": 1,
                },
    ...
    "sde2": {
        "object": {
            "name": "AA_SSSSSSSS.sCCCccccVaaaa_asd",
            "dataset_name": {
                "category": "",
                "name": "",
                "subset_names": None,
    ...
    "sql server no dbclient": {
        "object": {
            "name": "GDA.GDA.KP_Table",
            "dataset_name": {
                "category": "",
                "name": "",
                "subset_names": None,
    ...
    "sdc no connection": {
        ...
        "subset": "\"CAPTYPE\" = '1'",
        "expected": {
            "uri": "/home/me/test_slyr/Archive/LYRs/Data/ccccmmmm",
            "provider": "ogr",
            "wkb_type": 1,
    ...
    "sde dataset connection no dbclient subset": {
        "object": {
            "name": "eeeaaaaw.DBO.TTTTTT_AAAAAA_line",
            "dataset_name": {
    ...
    "sde sql server": {
        "object": {
            "name": "iiiiiiddddddd.IIIIIIIIAAAAAA.KK_aaaa_CCCC_dissolve",
            "dataset_name": {
    ...
    "Info table": {
        "object": {
            ...
            "workspace_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_FILESYSTEM_WORKSPACE",
                "workspace_factory": {"type": "ArcInfoWorkspaceFactory", "version": 1},
    ...
    "Table with ArcInfoWorkspaceFactory": {
        "object": {
            "name": "rrrrr_aaaaaa",
    ...
    "NetCDF table": {
        "object": {
            ...
            "workspace_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_FILESYSTEM_WORKSPACE",
                "workspace_factory": {"type": "NetCDFWorkspaceFactory", "version": 1},
    ...
    "sde oracle workspace with subset": {
        "object": {
            "name": "S_TTT.aAAAAAAsssspppttTTT",
            "dataset_name": {
                "category": "",
                "name": "",
                "subset_names": None,
    ...
    "sde sql server any geometry type": {
        "object": {
            "name": 'GIS."PROD\\BCVBBBBB".%vw_TTRA_AAA_ttttaaaammmaaasdtt',
            "dataset_name": {
                "name": "P:\\GISData\\ArcGIS\\GIS.sde",
                "browse_name": "ArcSDE Data",
                "connection_properties": {
                    "SERVER": "bnnnccc66aa1.prod.local",
        ...
        "object": {
            ...
            "dataset_name": {
                ...
                "workspace_name": {
                    ...
                    "path_name": "",
                    "workspace_type": "ESRI_FILESYSTEM_WORKSPACE",
                    "workspace_factory": {"type": "CadWorkspaceFactory", "version": 1},
                    "name_string": "",
                    "type": "WorkspaceName",
                    "version": 1,
                },
    ...
    "XY event source with join": {
        "object": {
            ...
            "event_properties": {
                "x_field": "Wwwww_AAaaaa_XY.INSIDE_X",
        ...
        "subset": "Wwwww_AAaaaa.Code NOT LIKE 'ABBBB%'",
        "skip_old": True,
        "expected": {"factory": "", "provider": "ogr", "uri": "temp", "wkb_type": 0},
    },
    "s57": {
        "object": {
            "name": "BOOPOOOA_4",
            "dataset_name": {
                ...
                "workspace_name": {
                    ...
                    "path_name": "",
                    "workspace_type": "ESRI_FILESYSTEM_WORKSPACE",
                    "workspace_factory": {"type": "S57WorkspaceFactory", "version": 1},
                    "name_string": "",
                    "type": "WorkspaceName",
                    "version": 1,
                },
    ...
    "ims": {
        "object": {
            ...
            "dataset_name": {
                ...
                "path_name": "",
                "workspace_type": "ESRI_REMOTEDATABASE_WORKSPACE",
                "workspace_factory": {"type": "IMSWorkspaceFactory", "version": 1},
                "name_string": "",
                "type": "WorkspaceName",
                "version": 1,
            },
...
class TestLayerSourceConversion(SlyrTestCase):
    ...
    def test_sources(self):
        ...
        for name, definition in expected.items():
            ...
            res = DatasetNameConverter.convert(
                obj,
    ...
    def test_split_to_tokens(self):
        ...
        self.assertEqual(
            DatasetNameConverter.split_to_tokens("aaA.bb11"), ["aaA", "bb11"]
        )
        self.assertEqual(
            DatasetNameConverter.split_to_tokens("aaA.bb11.cc-111"),
            ["aaA", "bb11", "cc-111"],
        )
        self.assertEqual(
            DatasetNameConverter.split_to_tokens("aaA.bb11.cc-111.5555"),
