...
expected = {
    ...
    'GPKG': {
        'object': {
            ...
            'datasource_type': 'Query Feature Class', 'feature_type': 'FT_SIMPLE',
            'shape_field_name': '',
            ...
            'query': {'query': 'select fid, geom from main.jjhjassddd', 'fid': 'fid',
                    ...
                    {'name': 'fid', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 6,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 0,
                     'scale': 0, 'editable': False, 'is_nullable': False, 'required': True,
                     'domain_fixed': False, 'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'geom', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 7,
                     'value_domain': None,
                     'geometry_definition': {'average_number_of_points': 0,
                                             ...
                                             'version': 1}, 'field_length': 4, 'precision': 0,
                     'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2}], 'type': 'Fields',
                    'version': 2},
                      'crs': {
                          'wkt': 'PROJCS["WGS 84 / Pseudo-Mercator",GEOGCS["WGS 84",DATUM["WGS_1984",SPHEROID["WGS 84",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["degree",0.0174532925199433]],PROJECTION["Mercator_1SP"],PARAMETER["false_easting",0.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",0.0],PARAMETER["scale_factor",1.0],UNIT["Metre",1.0]]',
                          ...
                          'is_high_precision': True, 'type': 'ProjectedCoordinateSystem',
                          'version': 6},
                      'type': 'GpkgFeatureClassQuery', 'version': 3},
    ...
    'sde2': {'object': {'name': 'AA_SSSSSSSS.sCCCccccVaaaa_asd',
                        'dataset_name': {'category': '', 'name': '', 'subset_names': None,
                                         ...
                                         'workspace_name': {
                                             ...
                                             'browse_name': 'ArcSDE Data',
                                             'connection_properties': {'SERVER': 'sde',
                        ...
                        'shape_field_name': 'SHAPE', 'shape_type': 'point',
                        'type': 'FeatureClassName', 'version': 2},
    ...
    'sql server': {'object': {'name': 'sde.START.AAA_Overlay_NNNnnnnnnRRRRrrrrrCCCccc',
                   ...
                   'expected': {
                       ...
                       'factory': 'SdeWorkspaceFactory'}},
    'sql server no dbclient': {'object': {"name": "GDA.GDA.KP_Table",
                                          "dataset_name": {
                                              "category": "",
                                              "name": "",
                                              "subset_names": None,
                                              "dataset_type": "DATASET_TYPE_CONTAINER",
                                              "workspace_name": {
                                                  "name": "C:\\Users\\someone\\AppData\\Roaming\\ESRI\\Desktop10.0\\ArcCatalog\\DBC_read_DC@db-dbc.sde",
                                                  "browse_name": "ArcSDE Data",
                                                  "connection_properties": {
                                                      "SERVER": "db-dbc.somewhere.local",
                                                      "INSTANCE": "sde:sqlserver:db-dbc.somewhere.local",
                                                      "DATABASE": "DBC",
                                                      "AUTHENTICATION_MODE": "DBMS",
                                                      "USER": "DBC_read",
                                                      "PASSWORD": "***************************",
    ...
    'sdc with workspace': {'object': {'name': 'continent',
                                      ...
                                      'datasource_type': 'SDC Feature Class',
                                      'feature_type': 'FT_SIMPLE',
                                      'shape_field_name': 'Shape', 'shape_type': 'polygon',
                                      'type': 'FeatureClassName',
    ...
    'sde no dbclient': {'object': {'name': 'SD_MMMMMM.SSSS_AAAA_BBBB', 'dataset_name': {
        ...
        'type': 'WorkspaceName',
        'version': 1}, 'datasource_type': 'SDE Feature Class', 'feature_type': 'FT_SIMPLE',
                                   'shape_field_name': 'SHAPE',
    ...
    'sde dataset connection no dbclient subset': {
        'object': {'name': 'eeeaaaaw.DBO.TTTTTT_AAAAAA_line',
                   'dataset_name': {
        ...
        'expected': {
            'uri': "dbname='eeeaaaaw' host=spatialdata key='OBJECTID' srid=26910 "
                   "type=LineString disableInvalidGeometryHandling='0' "
                   'table="DBO"."TTTTTT_AAAAAA_line" (SHAPE) sql=( Drivable LIKE '
                   "'%Yes%' AND ( left(CLASS_RNP, 1) = 5 OR left(CLASS_RNP, 1) = 6  OR "
                   'left(CLASS_RNP, 1) = 8  OR left(CLASS_RNP, 1) = 9 )  AND CLASS_RNP '
                   "LIKE '%TRAIL_%' ) AND MapDisplay >= 36",
            'provider': 'mssql',
            'wkb_type': 2,
            'factory': 'SdeWorkspaceFactory'
        }
    ...
    'sde sql server': {
        'object': {'name': 'iiiiiiddddddd.IIIIIIIIAAAAAA.KK_aaaa_CCCC_dissolve', 'dataset_name': {
            'name': 'C:\\Users\\pccccc\\AppData\\Roaming\\ESRI\\Desktop10.1\\ArcCatalog\\CAA_EEEE.sde',
            'browse_name': 'ArcSDE Data',
            'connection_properties': {'SERVER': 'keeeeaa3aa33',
                                      'INSTANCE': 'sde:sqlserver:keeeeaa3aa33\\sdesqlco',
                                      'DBCLIENT': 'sqlserver',
                                      'DB_CONNECTION_PROPERTIES': 'keeeeaa3aa33\\sdesqlco',
                                      'DATABASE': 'iiiiiiddddddd', 'IS_GEODATABASE': 'true',
                                      'AUTHENTICATION_MODE': 'OSA',
    ...
    'RelQueryTableName': {
        'object': {
            ...
            'filter': {'sub_fields': '*', 'where_clause': '',
                       ...
                       'output_spatial_reference': None, 'spatial_resolution': 0.0,
                       'postfix_clause': '',
                       'prefix_clause': '',
                       'filter_defs': {'type': 'ArrayOfFilterDef', 'version': 1},
                       'row_offset': None, 'row_count': None, 'spatial_relation': 0,
                       'spatial_relation_description': '', 'reference_geometry': None,
                       'geometry_field_name': 'Shape', 'fid_set': None, 'type': 'SpatialFilter',
                       'version': 1},
    ...
    'NetCDF table': {
        'object': {
            'name': '65T44_dasd_33_4_TTTT_TTttttt',
            'name_string': 'NetCDF Table: Workspace = \\AAA_Llllll_nnnnnn\\SSSSaaaa_DDDDD\\A3333\\Aewewe\\ASDd4344_rrrrr_ffff\\; Name = 65T44_dasd_33_4_TTTT_TTttttt;',
            'workspace_name': {
                'name': 'ASDd4344_rrrrr_ffff\\65T44_dasd_33_4_TTTT_TTttttt.nc',
                'browse_name': 'NetCDF: 65T44_dasd_33_4_TTTT_TTttttt.nc',
                'connection_properties': None, 'path_name': '',
                'workspace_type': 'ESRI_FILESYSTEM_WORKSPACE',
                'workspace_factory': {
                    'type': 'NetCDFWorkspaceFactory',
                    'version': 1
                },
                'name_string': 'NetCDF Workspace = J:\\AAA_Llllll_nnnnnn\\SSSSaaaa_DDDDD\\A3333\\Aewewe\\ASDd4344_rrrrr_ffff\\65T44_dasd_33_4_TTTT_TTttttt.nc;',
                'type': 'WorkspaceName', 'version': 1
            },
            'category': 'NetCDF Table',
            'variable_list': {'strings': ['z'], 'type': 'StrArray', 'version': 1},
            'dimension_list': {'strings': [], 'type': 'StrArray', 'version': 1},
            'type': 'NetCDFTableName',
            'version': 1
        },
        'base': '/home/me/test_slyr/Bbbbbbbb Aaaa/MXDs',
        'crs': '',
        ...
        'skip_old': True,
        'expected': {
            'file_name': '/home/me/test_slyr/Bbbbbbbb Aaaa/MXDs/ASDd4344_rrrrr_ffff/65T44_dasd_33_4_TTTT_TTttttt.nc',
            'uri': '/home/me/test_slyr/Bbbbbbbb Aaaa/MXDs/ASDd4344_rrrrr_ffff/65T44_dasd_33_4_TTTT_TTttttt.nc|layername=65T44_dasd_33_4_TTTT_TTttttt',
            'provider': 'ogr',
            'wkb_type': 100,
            'factory': 'NetCDFWorkspaceFactory'
        }
    },
    ...
    'RasterCatalogName': {
        'object': {
            'workspace_name': {
                'name': 'R:\\SPS_AAAA\\aerial\\Aaaaaa_Bbbbbbb.gdb',
                'browse_name': 'Aaaaaa_Bbbbbbb',
                'connection_properties': {
                    'DATABASE': 'R:\\SPS_AAAA\\aerial\\Aaaaaa_Bbbbbbb.gdb',
                    'type': 'PropertySet',
                    'version': 1
                },
                'path_name': '',
            ...
            'name': 'AAA_Bbbbbbb_CCC_DDD',
            'name_string': '',
            'datasource_type': 'File Geodatabase Raster Catalog',
            'shape_field_name': 'Shape',
            'shape_type': 4,
            'feature_type': 14,
            'type': 'RasterCatalogName',
            'version': 2
        },
        'base': '/home/me/test_slyr/ABBBB/r2/MXDs',
        'crs': 'EPSG:28356',
        'subset': "( PROJECT_NO = '30031710' )",
        'expected': {
            'uri': 'R:/SPS_AAAA/aerial/Aaaaaa_Bbbbbbb.gdb|layername=AAA_Bbbbbbb_CCC_DDD',
            'provider': 'ogr',
            'wkb_type': 6,
            'file_name': 'R:/SPS_AAAA/aerial/Aaaaaa_Bbbbbbb.gdb',
            'factory': 'FileGDBWorkspaceFactory'
        }
    },
    'SDE Table': {
    ...
    'sde sql server any geometry type': {
        'object': {'name': 'GIS."PROD\\BCVBBBBB".%vw_TTRA_AAA_ttttaaaammmaaasdtt',
                   'dataset_name': {'name': 'P:\\GISData\\ArcGIS\\GIS.sde',
                                    'browse_name': 'ArcSDE Data',
                ...
                'fid': 'OBJECTID', 'geometry_field': 'Shape', 'esri_oid': 'ESRI_OID',
                'fields': {'fields': [
                    {'name': 'OBJECTID', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 1,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 10, 'scale': 0,
                     'editable': True, 'is_nullable': False, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'TENEMENT', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 10,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'FMT_TENID', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 16,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'TENID', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 12,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'NAME', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 30,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'JV', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 10,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'REGION', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 5,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'PROJECT', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 11,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'TYPE', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 50,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'SURVSTATUS', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 15,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'TENSTATUS', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 10,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'HOLDERCNT', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 1,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 10, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'HOLDER1', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 80,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'ADDR1', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 150,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'HOLDER2', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 80,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'ADDR2', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 150,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'STARTDATE', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 5,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 36,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'STARTTIME', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'ENDDATE', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 5,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 36,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'ENDTIME', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'GRANTDATE', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 5,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 36,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'GRANTTIME', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'LEGAL_AREA', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 3,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'UNIT_OF_MEASURE', 'alias': '', 'model_name': '',
                     'default_value': None, 'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'SPECIAL_IND', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 1,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'EXTRACT_DATE', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 5,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 36,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'COMBINED_REPORTING_NO', 'alias': '', 'model_name': '',
                     'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 10,
                     'precision': 0, 'scale': 0,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'ALL_HOLDERS', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 200,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'AREA_KM2', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 3,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                     'precision': 38, 'scale': 8,
                     'editable': True, 'is_nullable': True, 'required': False,
                     ...
                     'raster_def': None,
                     'type': 'Field', 'version': 2},
                    {'name': 'COMBINED_REPORTING_NAME', 'alias': '', 'model_name': '',
                     'default_value': None,
                     'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                     'field_length': 40,
                     'precision': 0,
                     'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'Shape', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 7,
                     'value_domain': None,
                     'geometry_definition': {'average_number_of_points': 0,
                                             'geometry_type': 'polygon', 'crs': {
                             ...
                             'x_origin': -400.0, 'y_origin': -400.0, 'xy_scale': 999999999.9999999,
                             'z_origin': -100000.0,
                             'z_scale': 10000.0, 'm_origin': -100000.0, 'm_scale': 10000.0,
                             'xy_tolerance': 8.983152841195213e-09, 'z_tolerance': 0.001,
                             'm_tolerance': 0.001,
                             'is_high_precision': True, 'type': 'GeographicCoordinateSystem',
                             'version': 7}, 'has_m': False,
                                             'has_z': False, 'type': 'GeometryDef', 'version': 1},
                     'field_length': 4,
                     'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': True,
                     'required': False,
                     'domain_fixed': False, 'raster_def': None, 'type': 'Field', 'version': 2}],
                    'type': 'Fields',
                    'version': 2}, 'crs': {
                    ...
                    'type': 'GeographicCoordinateSystem', 'version': 7},
                'type': 'GpkgFeatureClassQuery', 'version': 2},
                   'type': 'GpkgFeatureClassName', 'version': 2},
        'base': '/home/me/test_slyr/Misc',
        'crs': 'EPSG:3111',
        'subset': '',
        'skip_old': True,
        'expected': {
            ...
            'uri': "dbname='GIS' host=bnnnccc66aa1.prod.local key='OBJECTID' srid=3111 "
                   "type=Polygon disableInvalidGeometryHandling='0' "
                   'table="GISDO"."vw_TTRA_AAA_ttttaaaammmaaasdtt" (Shape)',
            'wkb_type': 3
        }
    },
    'feature server 2': {
    ...
    'SQL server with escaped table name': {
        'object': {
            ...
            'query': {
                ...
                'fid': 'PLAN_LOT', 'geometry_field': 'Shape', 'esri_oid': 'ESRI_OID',
                'fields': {'fields': [
                    {'name': 'OBJECTID', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 1,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                    ...
                    {'name': 'Shape', 'alias': '', 'model_name': '', 'default_value': None,
                     ...
                     'geometry_definition': {'average_number_of_points': 0,
                             ...
                             'x_origin': -5120900.0, 'y_origin': 1900.0, 'm_origin': -100000.0,
                             'z_origin': -100000.0,
                             'xy_scale': 10000.0, 'm_scale': 10000.0, 'z_scale': 10000.0,
                             'xy_tolerance': 0.001,
                             'z_tolerance': 0.001, 'm_tolerance': 0.001, 'is_high_precision': True,
                             'type': 'ProjectedCoordinateSystem', 'version': 6}, 'has_m': False,
                                             'has_z': False,
                                             'type': 'GeometryDef', 'version': 1},
                     'field_length': 4, 'precision': 0,
                     'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'PLAN_LOT', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 25,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'parcel_num', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 1,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 10, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'gis_ref', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 20,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'parish', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 40,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'county', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 40,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'assessment_num', 'alias': '', 'model_name': '',
                     'default_value': None, 'field_type': 1,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 10, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'old_ass_num', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 15,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'house_number', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 133,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'street_name', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 40,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'street_type', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'suburb', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 35,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'joined_property_address', 'alias': '', 'model_name': '',
                     'default_value': None,
                     'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                     'field_length': 215,
                     'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': True,
                     'required': False,
                     'domain_fixed': False, 'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'area', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 3,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                     ...
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'area_measure', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 1,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'name1', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 50,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'name2', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 50,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'joined_owner_name', 'alias': '', 'model_name': '',
                     'default_value': None, 'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 101,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'address1', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 50,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'address2', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 50,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'address3', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 50,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'joined_poastal_address', 'alias': '', 'model_name': '',
                     'default_value': None,
                     'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                     'field_length': 152,
                     'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': True,
                     'required': False,
                     'domain_fixed': False, 'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'rates_zone', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'rates_class', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'rates_flag', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 1,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'parcel_flag', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 1,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'LOT', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 10,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
                     'domain_fixed': False,
                     'raster_def': None, 'type': 'Field', 'version': 2},
                    {'name': 'PLAN_', 'alias': '', 'model_name': '', 'default_value': None,
                     'field_type': 4,
                     'value_domain': None, 'geometry_definition': None, 'field_length': 15,
                     'precision': 0, 'scale': 0,
                     'editable': True, 'is_nullable': True, 'required': False,
    ...
    'XY event source with join': {
        'object': {
            ...
            'event_properties': {'x_field': 'Wwwww_AAaaaa_XY.INSIDE_X',
                ...
                'x_origin': -20037700.0, 'y_origin': -30241100.0, 'm_origin': -100000.0,
                'z_origin': -100000.0,
    ...
    'sql server dbtablename': {
        'object': {
            "name": "aaaa.dbo.vvvvvvv",
            "dataset_name": {
                "name": "I:\\xxxx\\aaaa.sde",
                "browse_name": "avavava",
                "connection_properties": {
                    "SERVER": "data.xxxxxxx.com",
                    "INSTANCE": "sde:sqlserver:data.xxxxxxx.com,8043",
                    "DBCLIENT": "sqlserver",
                    "DB_CONNECTION_PROPERTIES": "data.xxxxxxx.com,8043",
                    "DATABASE": "cccccvaaa",
        ...
        'subset': '',
        'skip_old': True,
        'expected': {'factory': 'SdeWorkspaceFactory',
                     'provider': 'mssql',
    ...
    'sql server standalone no geom': {
        'object': {
            "name": "aabb.dbo.vwbbcc",
            "dataset_name": {
                "name": "I:\\gdb_connections\\aaxx.sde",
                "browse_name": "ac",
                "connection_properties": {
                    "SERVER": "data.abc.com",
                    "INSTANCE": "sde:sqlserver:data.abc.com,8043",
                    "DBCLIENT": "sqlserver",
                    "DB_CONNECTION_PROPERTIES": "data.abc.com,8043",
                    "DATABASE": "AC",
                    "IS_GEODATABASE": "false",
                    "AUTHENTICATION_MODE": "DBMS",
                    "USER": "gisuser",
    ...
    'sql server query no geom': {
        'object': {'name': 'ge.gea.%french_cities', 'dataset_name': {
            'name': 'C:\\Users\\Desktop10.6\\ArcCatalog\\Connection to prd-sql.sde',
            'browse_name': 'Geo',
            'connection_properties': {'SERVER': 'prd-sql', 'INSTANCE': 'sde:sqlserver:host-name',
                                      'DBCLIENT': 'sqlserver',
                                      'DB_CONNECTION_PROPERTIES': 'host-name', 'DATABASE': 'Geo',
                                      'IS_GEODATABASE': 'false', 'AUTHENTICATION_MODE': 'DBMS',
                                      'USER': 'ga',
                                      'PASSWORD': '********************************************************',
                                      'CONNPROP-REV': 'Rev1.0', 'type': 'PropertySet',
                                      'version': 1, 'ref_id': 1126},
            'path_name': '', 'workspace_type': 'ESRI_REMOTEDATABASE_WORKSPACE',
            'workspace_factory': {'type': 'SdeWorkspaceFactory', 'version': 1}, 'name_string': '',
            'type': 'WorkspaceName', 'version': 1, 'ref_id': 1125},
                   'datasource_type': 'Query Table',
                   'feature_type': 'FT_SIMPLE', 'shape_field_name': '', 'shape_type': 'any',
                   'topologies': [],
                   'query': {
                       'query': 'select OID, Name, FeatureDescription, Latitude, Longitude, FeatureType, Admin_1, MalariaVisibility, MalariaRec, YellowFeverVisibility, YellowFeverRec, ElevationVisibility, ElevationRec, Zoom_4, Zoom_5, Zoom_6, Zoom_7, Zoom_8, Zoom_9 from Geo.ArcGis.colombia_cities',
                       'fid': 'OID', 'geometry_field': '', 'esri_oid': 'ESRI_OID',
                       'fields': {'fields': [
                           {'name': 'OID', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 10,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 38,
                            'precision': 0,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1129},
                           {'name': 'Name', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 4,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 255,
                            'precision': 0,
                            'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                            'domain_fixed': False,
                            'raster_def': None, 'type': 'Field', 'version': 3, 'ref_id': 1130},
                           {'name': 'FeatureDescription', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 2147483647, 'precision': 0, 'scale': 0,
                            'editable': True,
                            'is_nullable': True, 'required': False, 'domain_fixed': False,
                            'raster_def': None,
                            'type': 'Field', 'version': 3, 'ref_id': 1131},
                           {'name': 'Latitude', 'alias': '', 'model_name': '',
                            'default_value': None, 'field_type': 3,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                            'precision': 0,
                            'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                            'domain_fixed': False,
                            'raster_def': None, 'type': 'Field', 'version': 3, 'ref_id': 1132},
                           {'name': 'Longitude', 'alias': '', 'model_name': '',
                            'default_value': None, 'field_type': 3,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 8,
                            'precision': 0,
                            'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                            'domain_fixed': False,
                            'raster_def': None, 'type': 'Field', 'version': 3, 'ref_id': 1133},
                           {'name': 'FeatureType', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 100,
                            'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': True,
                            'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1134},
                           {'name': 'Admin_1', 'alias': '', 'model_name': '',
                            'default_value': None, 'field_type': 4,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 255,
                            'precision': 0,
                            'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                            'domain_fixed': False,
                            'raster_def': None, 'type': 'Field', 'version': 3, 'ref_id': 1135},
                           {'name': 'MalariaVisibility', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 5,
                            'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': False,
                            'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1136},
                           {'name': 'MalariaRec', 'alias': '', 'model_name': '',
                            'default_value': None, 'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': True, 'required': False,
                            'domain_fixed': False,
                            'raster_def': None, 'type': 'Field', 'version': 3, 'ref_id': 1137},
                           {'name': 'YellowFeverVisibility', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 5,
                            'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': False,
                            'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1138},
                           {'name': 'YellowFeverRec', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 1, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 4,
                            'precision': 10, 'scale': 0, 'editable': True, 'is_nullable': True,
                            'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1139},
                           {'name': 'ElevationVisibility', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 4, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 5,
                            'precision': 0, 'scale': 0, 'editable': True, 'is_nullable': False,
                            'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1140},
                           {'name': 'ElevationRec', 'alias': '', 'model_name': '',
                            'default_value': None,
                            'field_type': 1, 'value_domain': None, 'geometry_definition': None,
                            'field_length': 4,
                            'precision': 10, 'scale': 0, 'editable': True, 'is_nullable': True,
                            'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1141},
                           {'name': 'Zoom_4', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1142},
                           {'name': 'Zoom_5', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1143},
                           {'name': 'Zoom_6', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1144},
                           {'name': 'Zoom_7', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1145},
                           {'name': 'Zoom_8', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1146},
                           {'name': 'Zoom_9', 'alias': '', 'model_name': '', 'default_value': None,
                            'field_type': 1,
                            'value_domain': None, 'geometry_definition': None, 'field_length': 4,
                            'precision': 10,
                            'scale': 0, 'editable': True, 'is_nullable': False, 'required': False,
                            'domain_fixed': False, 'raster_def': None, 'type': 'Field',
                            'version': 3, 'ref_id': 1147}],
                           'type': 'Fields',
                           'version': 2,
                           'ref_id': 1128},
                       'crs': None, 'type': 'GpkgFeatureClassQuery', 'version': 3, 'ref_id': 1127},
                   'type': 'GpkgFeatureClassName', 'version': 2, 'ref_id': 1124},
        'base': '/home/me/data/Ddddddd',
        'crs': '',
        'subset': '',
        'skip_old': True,
    ...
    'sql server alternative port encoding': {
        'object': {
            "name": "MyConnection.DBO.%vwParcels_1_1_1",
            "dataset_name": {
                "name": "I:\\gdb_connections\\MyConnection.sde",
                "browse_name": "MyConnection",
                "connection_properties": {
                    "SERVER": "data.myconnection.com",
                    "INSTANCE": "sde:sqlserver:data.myconnection.com,8043",
                    "DBCLIENT": "sqlserver",
                    "DB_CONNECTION_PROPERTIES": "data.myconnection.com,8043",
                    "DATABASE": "MyDatabase",
                    "IS_GEODATABASE": "false",
                    "AUTHENTICATION_MODE": "DBMS",
                    "USER": "myuser",
            ...
            "topologies": [],
            "query": {
                "query": "select OBJECTID, Shape, NAME from MyDatabase.dbo.vwParcels",
                "fid": "OBJECTID",
                        ...
                        },
                        {
                            ...
                            "geometry_definition": {
                                ...
                                "crs": {
                                    ...
                                    "x_origin": -124791100.0,
                                    "y_origin": -91255500.0,
                                    "m_origin": -100000.0,
                                    "z_origin": -100000.0,
                                    "xy_scale": 3048.0060960121928,
                                    "m_scale": 10000.0,
                                    "z_scale": 10000.0,
                                    "xy_tolerance": 0.003280833333333333,
                                    "z_tolerance": 0.001,
                                    "m_tolerance": 0.001,
                                    "is_high_precision": True,
                                    "type": "ProjectedCoordinateSystem",
...
class TestLayerSourceConversion(unittest.TestCase):
    ...
    def test_split_to_tokens(self):
        ...
        self.assertEqual(DatasetNameConverter.split_to_tokens('aaA.bb11.cc-111'),
                         ['aaA', 'bb11', 'cc-111'])
