...
expected = {
    'colors_bin': {
        'HSV 60 40 30.bin': {
            'color': {'type': 'HsvColor', 'B': 46, 'G': 77, 'R': 76, 'dither': False, 'is_null': False, 'version': 1},
        },
        'Gray 47.bin': {
            'color': {'type': 'GrayColor', 'B': 47, 'G': 47, 'R': 47, 'dither': False, 'is_null': False, 'version': 1},
            },
        'CMYK 10 20 30 40.bin': {
            'color': {'type': 'CmykColor', 'C': 10, 'K': 40, 'M': 20, 'Y': 30, 'dither': False, 'is_null': False,
                      'version': 4},
        },
        'Name - Hot Pink.bin': {
            'color': {'type': 'HlsColor', 'B': 181, 'G': 107, 'R': 255, 'dither': False, 'is_null': False,
                      'version': 1},
        },
        'RGB 255 0 0.bin': {
            'color': {'type': 'RgbColor', 'B': 0, 'G': 0, 'R': 255, 'dither': False, 'is_null': False, 'version': 1},
            },
    }
}
