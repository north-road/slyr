...
If you are not copying the QGIS settings ini as part of the deployment, then you will also need to set the SLYR license key within the user's QGIS profile. This can be done programatically by calling a Python command:
