...
**1.1. License Entitlement**  
1.1.1 A SLYR license entitles the Licensee to installations as per the license workplace and user entitlements described in the license email.

**1.2. Workplace and User Entitlements**  
1.2.1 Scope of License: The Licensee’s right to use the Software is limited as per the license workplace and user entitlements described in the license email. This includes the maximum number of permitted physical workplace locations and the total number of authorized staff members (users).  

1.2.2 License Allocation Rules:  
The allocation of these entitlements is subject to the following rules:  

(a) Workplace Locations: The Software may only be used at the specific number of distinct physical workplace locations specified in the license email. Use of the Software at any additional location requires a license upgrade or the purchase of additional entitlements.

(b) Staff Access: The total number of staff members permitted to access or use the Software across all authorized locations is capped at the user limit specified in the license email. If the number of staff requiring access exceeds this entitlement, additional user licenses must be purchased.  

(c) Non-Transferability: Licenses or entitlements allocated to a specific workplace location are not transferable to other locations without prior written consent or a formal update to the license records.  

**1.3. Remote and Work From Home Users**  
1.3.1 Remote or “work from home” users shall be counted towards the staff limit of the physical workplace location to which they are formally assigned.  

1.3.2 Such users are entitled to utilize the license attached to their usual workplace office location, provided that location is appropriately licensed for its total number of assigned staff (inclusive of both in-office and remote users).  
