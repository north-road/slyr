...
A SLYR license entitles the licensee to installations accessible for up to 40 staff, within two (2) single physical
workplace locations. For the purposes of remote or “work from home” users, these users are entitled to utilize the
license attached to their usual workplace office location.

### Schedule 2 - License Fee

A limited install, two (2) standard workplace licenses are available for a one-time cost of 3000EU.
